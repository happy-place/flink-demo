...
import com.bigdata.flink.proj.taxi.app.RidesAndFaresExercise;
import com.bigdata.flink.proj.taxi.app.RidesAndFaresSolution;
import com.bigdata.flink.proj.testing.base.*;
...
public class RidesAndFaresTest extends TaxiRideTestBase<Tuple2<TaxiRide, TaxiFare>> {
	...
	public void testInOrder() throws Exception {
		...
		List<Tuple2<TaxiRide, TaxiFare>> expected = Arrays.asList(
				Tuple2.apply(ride2, fare2),
				Tuple2.apply(ride1, fare1)
				);

		// containsInAnyOrder 生成matcher 乱序比较
