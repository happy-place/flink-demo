 ...
 * metrics.reporter.promgateway.xxx 相关配置配在当前作业的resources/flink-conf.yaml 文件中
 */
public class MyClickEventCount2 {
	...
	public static void main(String[] args) throws Exception {
		...
		// 打jar包时 new Configuration() 会直接定位到flink-conf.yaml
        // Configuration configuration = new Configuration();

        // idea调试时，需要通过类加载器定位到flink-conf.yaml目录，然后创建configuration
